...
const Header = () => {
  ...
  <div className="relative group">
    ...
    <div className="absolute left-0 z-50 w-48 mt-2 bg-white shadow-xl rounded-md opacity-0 group-hover:opacity-100 transform scale-95 group-hover:scale-100 transition-all duration-300">
      <ul className="space-y-2 p-3">
        <li>
          <a
            href="#labs"
  ...
  <div className="relative group">
    <a
      href="#citizens"
      className="relative text-gray-700 z-50 text-xl hover:text-darkGreen-600 transform hover:scale-105 transition duration-300"
    >
      Actualites
      <span className="absolute left-0 bottom-0 w-0 h-1 bg-darkGreen-600 transition-all duration-300 hover:w-full"></span>
    </a>
    <div className="absolute left-0 w-48 mt-2 bg-white z-50 shadow-xl rounded-md opacity-0 group-hover:opacity-100 transform scale-95 group-hover:scale-100 transition-all duration-300">
      <ul className="space-y-2 p-3">
        <li>
          <a
            href="#news"
